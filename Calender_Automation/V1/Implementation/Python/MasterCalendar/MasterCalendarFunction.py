...
Initiative = "GENESIS"
OutMonth = "November"
InputPath = r"May_Calendar_v0.1.xlsx"


def MasterCalendarFunction(Initiative, OutMonth, InputPath):
...
if __name__ == "__main__":
    MasterCalendarFunction(Initiative, OutMonth, InputPath)
